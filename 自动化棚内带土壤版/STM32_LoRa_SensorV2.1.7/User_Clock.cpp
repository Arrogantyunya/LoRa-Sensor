 ...
 * @brief   将UTCTime转换为UTCTimeStruct
 *
 ...
 * @param	lpyr - 1表示闰年，否则为0
 *
 * @param   mon - 0 - 11 (jan - dec)
 * @param	mon - 0 - 11(1月- 12月)
 *
...
UTCTime osal_ConvertUTCSecs(UTCTimeStruct *tm)
{
	...
	tm->day -= 1;
	tm->month -= 1;
	/* Seconds for the partial day *//*部分天的秒数*/
