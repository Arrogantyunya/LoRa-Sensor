...
/*BKP register*/
//上一次开度值（百分比）保存地址
//Last opening value save address.
#define MOTOR_LAST_OPENING_ADDR             1
//本次开度值（百分比）保存地址
//Recent opening value save address.
#define MOTOR_RECENT_OPENING_ADDR           2
//实时开度值（百分比）保存地址
//Realtime opening value save address.
#define MOTOR_REALTIME_OPENING_ADDR         3    
