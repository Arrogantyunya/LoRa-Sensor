...
void LoRa::LoRa_AT(unsigned char *data_buffer, bool is_query, char *cmd, char *para)
{
  ...
  switch (Return_Type){
    ...
    case ERROR  : Serial.println("Receipt ERROR..."); break;
    case Bytes  : 
...
void LoRa::Parameter_Init(void)
{
    ...
    unsigned char buffer[10];
    LoRa_MHL9LF.LoRa_AT(buffer, false, AT_TFREQ, "1C578DE0");      
    LoRa_MHL9LF.LoRa_AT(buffer, false, AT_RFREQ, "1C03AE80");     
    LoRa_MHL9LF.LoRa_AT(buffer, false, AT_RIQ, "00"); 
    LoRa_MHL9LF.LoRa_AT(buffer, false, AT_NET, "01"); 
    LoRa_MHL9LF.LoRa_AT(buffer, false, AT_TSF, "09"); 
    LoRa_MHL9LF.LoRa_AT(buffer, false, AT_RSF, "09"); 
    LoRa_MHL9LF.LoRa_AT(buffer, false, AT_SIP, "01"); 
    LoRa_MHL9LF.LoRa_AT(buffer, false, AT_BW, "07"); 
    LoRa_MHL9LF.LoRa_AT(buffer, false, AT_POW, "14");       
}
