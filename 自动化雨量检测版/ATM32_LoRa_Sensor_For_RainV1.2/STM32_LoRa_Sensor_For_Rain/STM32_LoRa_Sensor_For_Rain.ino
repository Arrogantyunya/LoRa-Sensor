...
const unsigned char g_SN_Code[9] = {0x00}; //Defualt SN code is 0.

volatile unsigned long g_Cyc_Send_Data_Num = 0;
...
{
  g_Cyc_Send_Data_Num++;
  if (g_Cyc_Send_Data_Num >= WorkParameter_Info.Read_Collect_Time()){
    Timer2.pause();
    g_Cyc_Send_Data_Num = 0;
