...
/**< A way to get around Questions with shifting
    ...
    uint8_t value = 250;
    Serial1.println(value);              // --> 250
    Serial1.println(int8_t(value));      // --> -6
    Serial1.println(int8_t(value)<<8);   // --> -1536 = -6*256

    Serial1.println(uint8_t(value));      // --> 250
    Serial1.println(uint8_t(value)<<8);   // --> -1536 = -6*256 !!!!!!!!!!!!!!!!!!!!!!
    Serial1.println(uint16_t(value<<8)); // --> 64000
