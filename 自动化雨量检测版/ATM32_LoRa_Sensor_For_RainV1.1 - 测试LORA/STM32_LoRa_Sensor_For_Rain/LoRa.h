...
#define LORA_PWR_PIN    PA6

#define LoRa_Serial     Serial2  //USART2 --> USART1, when use serial upload
...
public:
    ...
    void Rewrite_ID(void);
    void Rewrite_GroupID(void);
    void Parameter_Init(void);
	void Parameter_ReInit(void);//将LORA设置为主机模式
